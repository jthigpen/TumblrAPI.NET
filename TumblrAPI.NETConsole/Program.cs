...
namespace TumblrAPI.ConsoleApp
{
    class Program
    {
        static void Main()
        {
			...
			string email = "tumblrapi@gmail.com"; // Console.ReadLine();

            //Console.WriteLine("Password: ");
			string password = "TumblrWithMe"; //Console.ReadLine();
            ...
            if (TumblrAPI.Authentication.Status == TumblrAPI.AuthenticationStatus.Valid) {
				...
				Console.WriteLine("  Message from text post: {0}", textPost.Publish().PostStatus);
